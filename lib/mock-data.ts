...
export const MOCK_METRIC_ENTRIES: DepartmentMetricEntry[] = [
  {
    id: "me1", departmentId: "dept1", reportingYearId: "ry1",
    category: "ACADEMIC", title: "University Rank Holders",
    description: "Students who secured University ranks in final semester exams. Arjun Selvam secured 3rd rank.",
    numericValue: 5, createdByUserId: "u3",
    status: "APPROVED", createdAt: "2024-01-10T10:00:00Z", updatedAt: "2024-01-15T10:00:00Z",
  },
  {
    id: "me2", departmentId: "dept1", reportingYearId: "ry1",
    category: "RESEARCH", title: "International Journal Publications",
    description: "Faculty published in IEEE, Springer and Elsevier journals. Lead author: Dr. Anitha Krishnamurthy.",
    numericValue: 18, createdByUserId: "u3",
    status: "APPROVED", createdAt: "2024-01-12T10:00:00Z", updatedAt: "2024-01-18T10:00:00Z",
  },
  {
    id: "me3", departmentId: "dept1", reportingYearId: "ry1",
    category: "STUDENT_ACHIEVEMENT", title: "Campus Placements",
    description: "Students placed in top MNCs including TCS, Infosys, Wipro, Zoho, and Cognizant from Chennai.",
    numericValue: 142, createdByUserId: "u3",
    status: "PENDING", createdAt: "2024-02-01T10:00:00Z", updatedAt: "2024-02-01T10:00:00Z",
  },
  {
    id: "me4", departmentId: "dept1", reportingYearId: "ry1",
    category: "EXTRACURRICULAR", title: "Technical Symposium - TechVista 2024",
    description: "Annual technical symposium with 500+ participants from colleges across Tamil Nadu.",
    numericValue: 520, createdByUserId: "u2",
    status: "APPROVED", createdAt: "2024-02-10T10:00:00Z", updatedAt: "2024-02-15T10:00:00Z",
  },
  {
    id: "me5", departmentId: "dept1", reportingYearId: "ry1",
    category: "FACULTY_ACHIEVEMENT", title: "AICTE Sponsored Research Projects",
    description: "Faculty secured funded projects from AICTE, DST-SERB. Total funding received.",
    numericValue: 3, createdByUserId: "u3",
    status: "REJECTED",
    reviewerComment: "Please attach proof of funding documents and project sanction letters.",
    createdAt: "2024-02-20T10:00:00Z", updatedAt: "2024-02-25T10:00:00Z",
  },
  {
    id: "me6", departmentId: "dept1", reportingYearId: "ry1",
    category: "INFRASTRUCTURE", title: "New AI & ML Lab Setup",
    description: "State-of-the-art AI lab with 40 high-performance workstations funded by alumni association.",
    numericValue: 40, createdByUserId: "u2",
    status: "APPROVED", createdAt: "2024-03-01T10:00:00Z", updatedAt: "2024-03-05T10:00:00Z",
  },
  {
    id: "me7", departmentId: "dept2", reportingYearId: "ry1",
    category: "RESEARCH", title: "Conference Papers Presented",
    description: "Papers presented in national and international conferences by ECE faculty.",
    numericValue: 22, createdByUserId: "u5",
    status: "APPROVED", createdAt: "2024-01-20T10:00:00Z", updatedAt: "2024-01-25T10:00:00Z",
  },
  {
    id: "me8", departmentId: "dept2", reportingYearId: "ry1",
    category: "STUDENT_ACHIEVEMENT", title: "GATE Qualified Students",
    description: "Students qualified GATE 2024 from ECE department.",
    numericValue: 12, createdByUserId: "u5",
    status: "PENDING", createdAt: "2024-02-05T10:00:00Z", updatedAt: "2024-02-05T10:00:00Z",
  },
  {
    id: "me9", departmentId: "dept3", reportingYearId: "ry1",
    category: "ACADEMIC", title: "Pass Percentage - Final Year",
    description: "Overall pass percentage of final year Mechanical Engineering students.",
    numericValue: 94, textualValue: "94%",
    createdByUserId: "u6",
    status: "SUBMITTED", createdAt: "2024-02-15T10:00:00Z", updatedAt: "2024-02-15T10:00:00Z",
  },
  {
    id: "me10", departmentId: "dept1", reportingYearId: "ry1",
    category: "FINANCIAL", title: "Department Budget Utilization",
    description: "Annual departmental budget utilization for lab maintenance, consumables and events.",
    numericValue: 85, textualValue: "85% utilized",
    createdByUserId: "u2",
    status: "PENDING", createdAt: "2024-03-10T10:00:00Z", updatedAt: "2024-03-10T10:00:00Z",
  },
];
